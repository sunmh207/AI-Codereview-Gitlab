<template>
  <div class="mr-reviews-view">
    <div class="page-header">
      <h1 class="page-title">合并请求审查</h1>
      <p class="page-description">查看和管理所有合并请求的代码审查记录</p>
    </div>
...
import { getMRReviews, getMetadata, type ReviewData, type ReviewFilters } from '@/api/reviews'
...
const loadData = async () => {
  ...
  try {
    ...
    const result = await getMRReviews(params)
...
const loadMetadata = async () => {
  try {
    const result = await getMetadata({ type: 'mr' })
